...
const WarningSuccessButtonSVGComponent = ({ innerStyle, ...props }) => (
  <svg width={100} height={100} xmlns="http://www.w3.org/2000/svg" style={innerStyle} {...props}>
    <defs>
      ...
      <radialGradient id="warning_btn_success_gradient" cx="50%" cy="50%" r="75%">
        <stop
          offset="0%"
          style={{
    ...
    <circle
      ...
      cy={50}
      r={21}
      fill="url(#warning_btn_success_gradient)"
      stroke="gray"
      strokeWidth={1}
    />
  </svg>
)
export default WarningSuccessButtonSVGComponent
