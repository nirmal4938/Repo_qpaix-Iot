...
const WarningNormalButtonSVGComponent = (props) => (
  <svg width={100} height={100} xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      ...
      <radialGradient id="warning_btn_normal_gradient" cx="50%" cy="50%" r="75%">
        <stop
          offset="0%"
          style={{
            stopColor: 'lightgray',
    ...
    <circle
      ...
      cy={50}
      r={21}
      fill="url(#warning_btn_normal_gradient)"
      stroke="gray"
      strokeWidth={1}
    />
  </svg>
)
export default WarningNormalButtonSVGComponent
